...
static __inline void insb(unsigned short int port, void *addr,
...
static __inline void insw(unsigned short int port, void *addr,
                          unsigned long int count)
{
...
static __inline void insl(unsigned short int port, void *addr,
                          unsigned long int count)
{
...
static __inline void outsb(unsigned short int port, const void *addr,
                           unsigned long int count)
{
...
static __inline void outsw(unsigned short int port, const void *addr,
                           unsigned long int count)
{
...
static __inline void outsl(unsigned short int port, const void *addr,
                           unsigned long int count)
{
